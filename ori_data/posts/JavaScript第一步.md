...
- [在网页中应用js](#在网页中应用js)
  - [向页面添加js](#向页面添加js)
    - [内部javascript](#内部javascript)
    - [外部javascript](#外部javascript)
    - [内联javascript处理器](#内联javascript处理器)
  - [脚本调用策略](#脚本调用策略)
    - [内部js](#内部js)
    - [外部js](#外部js)
- [javascript初体验](#javascript初体验)
  - [提出问题](#提出问题)
  - [解决问题](#解决问题)
    - [初始设置](#初始设置)
    - [添加变量](#添加变量)
    - [函数function](#函数function)
    - [条件语句conditional](#条件语句conditional)
    - [事件event](#事件event)
    - [补全游戏功能](#补全游戏功能)
    - [循环loop](#循环loop)
    - [浅谈对象object](#浅谈对象object)
  - [注释](#注释)
- [变量](#变量)
  - [变量类型](#变量类型)
    - [number](#number)
